...
$client = ClientBuilder::create()
            ->setSelector('\BeynElasticsearch\ConnectionPool\Selectors\RoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\BeynElasticsearch\ConnectionPool\Selectors\StickyRoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\BeynElasticsearch\ConnectionPool\Selectors\RandomSelector')
            ->build();
----
