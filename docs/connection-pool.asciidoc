...
$client = ClientBuilder::create()
            ->setConnectionPool('\BeynElasticsearch\ConnectionPool\StaticNoPingConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\BeynElasticsearch\ConnectionPool\StaticConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\BeynElasticsearch\ConnectionPool\SimpleConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\BeynElasticsearch\ConnectionPool\SniffingConnectionPool', [])
            ->build();
----
