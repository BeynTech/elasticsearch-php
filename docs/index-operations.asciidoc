...
Index management operations allow you to manage the indices in your BeynElasticsearch cluster, such as creating, deleting and
...
$client->indices()->
----
And perusing the list of available methods.  Alternatively, browsing the `\BeynElasticsearch\Namespaces\Indices.php` file will show you the full list of available method calls (as well as parameter lists in the comments for each method).
