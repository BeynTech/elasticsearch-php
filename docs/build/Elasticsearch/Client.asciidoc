...
[[BeynElasticsearch_Client]]
=== BeynElasticsearch\Client
...
* <<BeynElasticsearch_Clientinfo_info,`info()`>>
* <<BeynElasticsearch_Clientping_ping,`ping()`>>
* <<BeynElasticsearch_Clientget_get,`get()`>>
* <<BeynElasticsearch_ClientgetSource_getSource,`getSource()`>>
* <<BeynElasticsearch_Clientdelete_delete,`delete()`>>
* <<BeynElasticsearch_ClientdeleteByQuery_deleteByQuery,`deleteByQuery()`>>
* <<BeynElasticsearch_Clientcount_count,`count()`>>
* <<BeynElasticsearch_ClientcountPercolate_countPercolate,`countPercolate()`>>
* <<BeynElasticsearch_Clientpercolate_percolate,`percolate()`>>
* <<BeynElasticsearch_Clientmpercolate_mpercolate,`mpercolate()`>>
* <<BeynElasticsearch_Clienttermvectors_termvectors,`termvectors()`>>
* <<BeynElasticsearch_Clientmtermvectors_mtermvectors,`mtermvectors()`>>
* <<BeynElasticsearch_Clientexists_exists,`exists()`>>
* <<BeynElasticsearch_Clientmget_mget,`mget()`>>
* <<BeynElasticsearch_Clientmsearch_msearch,`msearch()`>>
* <<BeynElasticsearch_ClientmsearchTemplate_msearchTemplate,`msearchTemplate()`>>
* <<BeynElasticsearch_Clientcreate_create,`create()`>>
* <<BeynElasticsearch_Clientbulk_bulk,`bulk()`>>
* <<BeynElasticsearch_Clientindex_index,`index()`>>
* <<BeynElasticsearch_Clientreindex_reindex,`reindex()`>>
* <<BeynElasticsearch_Clientsuggest_suggest,`suggest()`>>
* <<BeynElasticsearch_Clientexplain_explain,`explain()`>>
* <<BeynElasticsearch_Clientsearch_search,`search()`>>
* <<BeynElasticsearch_ClientsearchShards_searchShards,`searchShards()`>>
* <<BeynElasticsearch_ClientsearchTemplate_searchTemplate,`searchTemplate()`>>
* <<BeynElasticsearch_Clientscroll_scroll,`scroll()`>>
* <<BeynElasticsearch_ClientclearScroll_clearScroll,`clearScroll()`>>
* <<BeynElasticsearch_Clientupdate_update,`update()`>>
* <<BeynElasticsearch_ClientupdateByQuery_updateByQuery,`updateByQuery()`>>
* <<BeynElasticsearch_ClientgetScript_getScript,`getScript()`>>
* <<BeynElasticsearch_ClientdeleteScript_deleteScript,`deleteScript()`>>
* <<BeynElasticsearch_ClientputScript_putScript,`putScript()`>>
* <<BeynElasticsearch_ClientgetTemplate_getTemplate,`getTemplate()`>>
* <<BeynElasticsearch_ClientdeleteTemplate_deleteTemplate,`deleteTemplate()`>>
* <<BeynElasticsearch_ClientfieldStats_fieldStats,`fieldStats()`>>
* <<BeynElasticsearch_ClientfieldCaps_fieldCaps,`fieldCaps()`>>
* <<BeynElasticsearch_ClientrenderSearchTemplate_renderSearchTemplate,`renderSearchTemplate()`>>
* <<BeynElasticsearch_Clientindices_indices,`indices()`>>
* <<BeynElasticsearch_Clientcluster_cluster,`cluster()`>>
* <<BeynElasticsearch_Clientnodes_nodes,`nodes()`>>
* <<BeynElasticsearch_Clientsnapshot_snapshot,`snapshot()`>>
* <<BeynElasticsearch_Clientcat_cat,`cat()`>>
* <<BeynElasticsearch_Clientingest_ingest,`ingest()`>>
* <<BeynElasticsearch_Clienttasks_tasks,`tasks()`>>
* <<BeynElasticsearch_Clientremote_remote,`remote()`>>
* <<BeynElasticsearch_Client-call-_call,`__call()`>>
* <<BeynElasticsearch_ClientextractArgument_extractArgument,`extractArgument()`>>




[[BeynElasticsearch_Clientinfo_info]]
.`info()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientping_ping]]
.`ping()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientget_get]]
.`get()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientgetSource_getSource]]
.`getSource()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientdelete_delete]]
.`delete()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientdeleteByQuery_deleteByQuery]]
.`deleteByQuery()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientcount_count]]
.`count()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientcountPercolate_countPercolate]]
.`countPercolate()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientpercolate_percolate]]
.`percolate()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientmpercolate_mpercolate]]
.`mpercolate()`
****
[source,php]
----
...
[[BeynElasticsearch_Clienttermvectors_termvectors]]
.`termvectors()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientmtermvectors_mtermvectors]]
.`mtermvectors()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientexists_exists]]
.`exists()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientmget_mget]]
.`mget()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientmsearch_msearch]]
.`msearch()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientmsearchTemplate_msearchTemplate]]
.`msearchTemplate()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientcreate_create]]
.`create()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientbulk_bulk]]
.`bulk()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientindex_index]]
.`index()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientreindex_reindex]]
.`reindex()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientsuggest_suggest]]
.`suggest()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientexplain_explain]]
.`explain()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientsearch_search]]
.`search()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientsearchShards_searchShards]]
.`searchShards()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientsearchTemplate_searchTemplate]]
.`searchTemplate()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientscroll_scroll]]
.`scroll()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientclearScroll_clearScroll]]
.`clearScroll()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientupdate_update]]
.`update()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientupdateByQuery_updateByQuery]]
.`updateByQuery()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientgetScript_getScript]]
.`getScript()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientdeleteScript_deleteScript]]
.`deleteScript()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientputScript_putScript]]
.`putScript()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientgetTemplate_getTemplate]]
.`getTemplate()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientdeleteTemplate_deleteTemplate]]
.`deleteTemplate()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientfieldStats_fieldStats]]
.`fieldStats()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientfieldCaps_fieldCaps]]
.`fieldCaps()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientrenderSearchTemplate_renderSearchTemplate]]
...
[[BeynElasticsearch_Clientindices_indices]]
.`indices()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientcluster_cluster]]
.`cluster()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientnodes_nodes]]
.`nodes()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientsnapshot_snapshot]]
.`snapshot()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientcat_cat]]
.`cat()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientingest_ingest]]
.`ingest()`
****
[source,php]
----
...
[[BeynElasticsearch_Clienttasks_tasks]]
.`tasks()`
****
[source,php]
----
...
[[BeynElasticsearch_Clientremote_remote]]
.`remote()`
****
[source,php]
----
...
[[BeynElasticsearch_Client-call-_call]]
.`__call()`
****
[source,php]
----
...
[[BeynElasticsearch_ClientextractArgument_extractArgument]]
.`extractArgument()`
****
[source,php]
----
