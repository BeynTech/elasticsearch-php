...
use BeynElasticsearch\ConnectionPool\StaticConnectionPool;
...
class StaticConnectionPoolTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddOneHostThenGetConnection()
    {
        ...
        /**
 * @var \BeynElasticsearch\Connections\Connection[]&\Mockery\MockInterface[] $connections
*/
    ...
    public function testAllHostsFailPing()
    {
        ...
        $this->expectException(\BeynElasticsearch\Common\Exceptions\NoNodesAvailableException::class);
    ...
    {
        $clientBuilder = \BeynElasticsearch\ClientBuilder::create();
