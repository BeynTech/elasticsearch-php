...
class RoundRobinSelectorTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers \BeynElasticsearch\ConnectionPool\Selectors\RoundRobinSelector::select
     *
     * @return void
     */
    public function testTenConnections()
    {
        $roundRobin = new BeynElasticsearch\ConnectionPool\Selectors\RoundRobinSelector();
